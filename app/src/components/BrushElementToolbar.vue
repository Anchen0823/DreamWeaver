<template>
  ...
  >
    ...
    <div class="toolbar-group">
      <ColorPicker
        :model-value="brushElement.color"
    ...
    <div class="toolbar-group">
      <input
        type="range"
        :value="brushElement.strokeWidth"
...
import type { BrushElement } from '../types/canvas'
import ColorPicker from './ColorPicker.vue'

const props = defineProps<{
  brushElement: BrushElement | null
  visible: boolean
